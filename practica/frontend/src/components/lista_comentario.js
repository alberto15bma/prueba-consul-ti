...
const roles = ["Administrador", "Usuario"]
 ...
 class Comentario extends Component {
    ...
    cargarComentarios = async () => {
        let res = await app.consulta(apis.lista_comentarios, null, app.metodo.GET);
        console.log(res);
        if(res !== null)
    ...
    render() {     
          return (
            <Fragment>
                <header>
                <div>
                    <Button text="Eliminar" disabled={this.state.activar_edicion} type="normal" onClick={() => this.abrirModal("eliminar")}/>
                ...
                <DataGrid
                            id="gridContainer"
                            dataSource={this.state.comentarios}
                            keyExpr="id"
                            showRowLines={true}
                        ...
                        >
                            ...
                            <Column dataField="usuario.nombre" caption="Nombre de usuario"/>
                            <Column dataField="fecha" caption="Fecha creación" format="dd/MM/yyyy" dataType="date"/>
                            <Pager
                                visible={true}
